...
public class ReducedAlfSystem extends XsemanticsRuntimeSystem {
  ...
  public final static String ENUMERATIONLITERAL = "com.incquerylabs.uml.ralf.EnumerationLiteral";
  ...
  public final static String EXPRESSIONOBJECTTYPE = "com.incquerylabs.uml.ralf.ExpressionObjectType";
  ...
  public void init() {
    typeDispatcher = buildPolymorphicDispatcher1(
    	"typeImpl", 3, "|-", ":");
    objectTypeDispatcher = buildPolymorphicDispatcher1(
    	"objectTypeImpl", 4, "|-", ":", ":");
  ...
  public void setContextAccess(final IUMLContextProviderAccess contextAccess) {
  ...
  public Result<IUMLTypeReference> type(final Expression expression) {
    return type(new RuleEnvironment(), null, expression);
  }
  
  public Result<IUMLTypeReference> type(final RuleEnvironment _environment_, final Expression expression) {
    return type(_environment_, null, expression);
  }
  
  public Result<IUMLTypeReference> type(final RuleEnvironment _environment_, final RuleApplicationTrace _trace_, final Expression expression) {
    try {
  ...
  public Result<IUMLTypeReference> objectType(final EObject obj, final EObject ctx) {
    return objectType(new RuleEnvironment(), null, obj, ctx);
  }
  
  public Result<IUMLTypeReference> objectType(final RuleEnvironment _environment_, final EObject obj, final EObject ctx) {
    return objectType(_environment_, null, obj, ctx);
  }
  
  public Result<IUMLTypeReference> objectType(final RuleEnvironment _environment_, final RuleApplicationTrace _trace_, final EObject obj, final EObject ctx) {
    try {
    	return objectTypeInternal(_environment_, _trace_, obj, ctx);
    } catch (Exception _e_objectType) {
    	return resultForFailure(_e_objectType);
    }
  }
  ...
  protected Result<Boolean> variableTypeInternal(final RuleApplicationTrace _trace_, final Variable var) throws RuleFailedException {
    ...
    IUMLTypeReference type = null;
    Result<IUMLTypeReference> result = objectTypeInternal(emptyEnvironment(), _trace_, var, var);
    checkAssignableTo(result.getFirst(), IUMLTypeReference.class);
    type = (IUMLTypeReference) result.getFirst();
  ...
  protected Result<Boolean> localNameDeclarationStatementTypeInternal(final RuleApplicationTrace _trace_, final LocalNameDeclarationStatement st) throws RuleFailedException {
    ...
    Result<IUMLTypeReference> result = objectTypeInternal(emptyEnvironment(), _trace_, _variable, st);
    checkAssignableTo(result.getFirst(), IUMLTypeReference.class);
    ...
    if (_notEquals) {
      ...
      IUMLContextProvider _umlContextProviderFor = this.contextAccess.getUmlContextProviderFor(st);
      subtypeReferenceInternal(emptyEnvironment(), _trace_, varType, valueType, _umlContextProviderFor);
    }
    return new Result<Boolean>(true);
  }
  ...
  protected Result<Boolean> ifClauseInternal(final RuleApplicationTrace _trace_, final IfClause cl) throws RuleFailedException {
    ...
    final IUMLContextProvider umlContextProvider = this.contextAccess.getUmlContextProviderFor(cl);
    /* empty |- condType <: BOOLEAN.primitiveTypeReference(umlContextProvider) : umlContextProvider */
    PrimitiveTypeReference _primitiveTypeReference = this.typeFactory.primitiveTypeReference(this.BOOLEAN, umlContextProvider);
    subtypeReferenceInternal(emptyEnvironment(), _trace_, condType, _primitiveTypeReference, umlContextProvider);
    return new Result<Boolean>(true);
  }
  ...
  protected Result<Boolean> forStatementInternal(final RuleApplicationTrace _trace_, final ForStatement st) throws RuleFailedException {
    ...
    final IUMLContextProvider umlContextProvider = this.contextAccess.getUmlContextProviderFor(st);
    /* empty |- condType <: BOOLEAN.primitiveTypeReference(umlContextProvider) : umlContextProvider */
    PrimitiveTypeReference _primitiveTypeReference = this.typeFactory.primitiveTypeReference(this.BOOLEAN, umlContextProvider);
    subtypeReferenceInternal(emptyEnvironment(), _trace_, condType, _primitiveTypeReference, umlContextProvider);
    return new Result<Boolean>(true);
  ...
  protected Result<Boolean> forEachStatementInternal(final RuleApplicationTrace _trace_, final ForEachStatement st) throws RuleFailedException {
    ...
    Result<IUMLTypeReference> result_1 = objectTypeInternal(emptyEnvironment(), _trace_, _variableDefinition, st);
    checkAssignableTo(result_1.getFirst(), IUMLTypeReference.class);
    ...
    if ((exType instanceof CollectionTypeReference)) {
      ...
      IUMLContextProvider _umlContextProviderFor = this.contextAccess.getUmlContextProviderFor(st);
      subtypeReferenceInternal(emptyEnvironment(), _trace_, _valueType, defType, _umlContextProviderFor);
    } else {
  ...
  protected Result<Boolean> switchStatement_Internal(final RuleApplicationTrace _trace_, final SwitchStatement st) throws RuleFailedException {
    ...
    final IUMLContextProvider umlContextProvider = this.contextAccess.getUmlContextProviderFor(st);
    /* { INTEGER.primitiveTypeReference(umlContextProvider) == eType } or { STRING.primitiveTypeReference(umlContextProvider) == eType } */
    {
      RuleFailedException previousFailure = null;
      try {
        PrimitiveTypeReference _primitiveTypeReference = this.typeFactory.primitiveTypeReference(this.INTEGER, umlContextProvider);
        ...
        PrimitiveTypeReference _primitiveTypeReference_1 = this.typeFactory.primitiveTypeReference(this.STRING, umlContextProvider);
  ...
  protected Result<Boolean> returnStatementInternal(final RuleApplicationTrace _trace_, final ReturnStatement st) throws RuleFailedException {
    final IUMLContextProvider umlContextProvider = this.contextAccess.getUmlContextProviderFor(st);
    Operation _definedOperation = umlContextProvider.getDefinedOperation(st);
    ...
    /* { returnValue == null st.expression == null } or { returnValue != null st.expression != null empty |- st.expression : var IUMLTypeReference exprType val returnType = returnValue.type.typeReference empty |- returnType <: exprType : umlContextProvider } or { returnValue == null st.expression != null fail error "Unexpected return value " + st.expression.stringRep source st.expression } */
    {
      RuleFailedException previousFailure = null;
      try {
        ...
        previousFailure = extractRuleFailedException(e);
        /* { returnValue != null st.expression != null empty |- st.expression : var IUMLTypeReference exprType val returnType = returnValue.type.typeReference empty |- returnType <: exprType : umlContextProvider } or { returnValue == null st.expression != null fail error "Unexpected return value " + st.expression.stringRep source st.expression } */
        {
          try {
            ...
            subtypeReferenceInternal(emptyEnvironment(), _trace_, returnType, exprType, umlContextProvider);
          } catch (Exception e_1) {
  ...
  protected Result<IUMLTypeReference> typeInternal(final RuleEnvironment _environment_, final RuleApplicationTrace _trace_, final Expression expression) {
    try {
  ...
  protected Result<IUMLTypeReference> objectTypeInternal(final RuleEnvironment _environment_, final RuleApplicationTrace _trace_, final EObject obj, final EObject ctx) {
    try {
    	checkParamsNotNull(obj, ctx);
    	return objectTypeDispatcher.invoke(_environment_, _trace_, obj, ctx);
    } catch (Exception _e_objectType) {
    	sneakyThrowRuleFailedException(_e_objectType);
    	return null;
    }
  }
  
  protected void objectTypeThrowException(final String _error, final String _issue, final Exception _ex, final EObject obj, final EObject ctx, final ErrorInformation[] _errorInformations) throws RuleFailedException {
  ...
  protected Set<Operation> applyAuxFunConstructorOperationCandidates(final RuleApplicationTrace _trace_, final org.eclipse.uml2.uml.Class cl, final Tuple parameters) throws RuleFailedException {
    IUMLContextProvider _umlContextProviderFor = this.contextAccess.getUmlContextProviderFor(parameters);
    return _umlContextProviderFor.getConstructorsOfClass(cl);
  }
  ...
  protected IUMLTypeReference applyAuxFunReplaceGenericTypeReference(final RuleApplicationTrace _trace_, final RuleEnvironment G, final IUMLTypeReference ref, final EObject ctx) throws RuleFailedException {
    ...
    if (!_and_1) {
      ...
      IUMLContextProvider _umlContextProviderFor = this.contextAccess.getUmlContextProviderFor(ctx);
      Classifier _genericCollectionParameterType = _umlContextProviderFor.getGenericCollectionParameterType();
    ...
    if (_and) {
      IUMLTypeReference _xblockexpression = null;
      {
        ...
        Result<IUMLTypeReference> result = objectTypeInternal(G, _trace_, ctx, ctx);
  ...
  private PrimitiveTypeReference _applyRuleBooleanLiteral_1(final RuleEnvironment G, final BooleanLiteralExpression bool) throws RuleFailedException {
    IUMLContextProvider _umlContextProviderFor = this.contextAccess.getUmlContextProviderFor(bool);
    PrimitiveTypeReference _primitiveTypeReference = this.typeFactory.primitiveTypeReference(this.BOOLEAN, _umlContextProviderFor);
  ...
  private PrimitiveTypeReference _applyRuleNaturalLiteral_1(final RuleEnvironment G, final NaturalLiteralExpression natural) throws RuleFailedException {
    IUMLContextProvider _umlContextProviderFor = this.contextAccess.getUmlContextProviderFor(natural);
    PrimitiveTypeReference _primitiveTypeReference = this.typeFactory.primitiveTypeReference(this.INTEGER, _umlContextProviderFor);
    return _primitiveTypeReference;
  }
  ...
  private PrimitiveTypeReference _applyRuleRealLiteral_1(final RuleEnvironment G, final RealLiteralExpression real) throws RuleFailedException {
    IUMLContextProvider _umlContextProviderFor = this.contextAccess.getUmlContextProviderFor(real);
    PrimitiveTypeReference _primitiveTypeReference = this.typeFactory.primitiveTypeReference(this.REAL, _umlContextProviderFor);
    return _primitiveTypeReference;
  }
  ...
  private PrimitiveTypeReference _applyRuleStringLiteral_1(final RuleEnvironment G, final StringLiteralExpression string) throws RuleFailedException {
    IUMLContextProvider _umlContextProviderFor = this.contextAccess.getUmlContextProviderFor(string);
    PrimitiveTypeReference _primitiveTypeReference = this.typeFactory.primitiveTypeReference(this.STRING, _umlContextProviderFor);
    return _primitiveTypeReference;
  }
  ...
  protected Result<IUMLTypeReference> objectTypeImpl(final RuleEnvironment G, final RuleApplicationTrace _trace_, final TypeDeclaration typeDecl, final EObject ctx) throws RuleFailedException {
    try {
    	final RuleApplicationTrace _subtrace_ = newTrace(_trace_);
    	final Result<IUMLTypeReference> _result_ = applyRuleTypeDeclaration(G, _subtrace_, typeDecl, ctx);
    	addToTrace(_trace_, new Provider<Object>() {
    		public Object get() {
    			return ruleName("TypeDeclaration") + stringRepForEnv(G) + " |- " + stringRep(typeDecl) + " : " + stringRep(ctx) + " : " + stringRep(_result_.getFirst());
    		}
    	});
    	addAsSubtrace(_trace_, _subtrace_);
    	return _result_;
    } catch (Exception e_applyRuleTypeDeclaration) {
    	objectTypeThrowException(ruleName("TypeDeclaration") + stringRepForEnv(G) + " |- " + stringRep(typeDecl) + " : " + stringRep(ctx) + " : " + "IUMLTypeReference",
    		TYPEDECLARATION,
    		e_applyRuleTypeDeclaration, typeDecl, ctx, new ErrorInformation[] {new ErrorInformation(typeDecl), new ErrorInformation(ctx)});
    	return null;
    }
  }
  
  protected Result<IUMLTypeReference> applyRuleTypeDeclaration(final RuleEnvironment G, final RuleApplicationTrace _trace_, final TypeDeclaration typeDecl, final EObject ctx) throws RuleFailedException {
  ...
  protected Result<IUMLTypeReference> objectTypeImpl(final RuleEnvironment G, final RuleApplicationTrace _trace_, final Variable variable, final EObject ctx) throws RuleFailedException {
    try {
    	final RuleApplicationTrace _subtrace_ = newTrace(_trace_);
    	final Result<IUMLTypeReference> _result_ = applyRuleVariableDeclaration(G, _subtrace_, variable, ctx);
    	addToTrace(_trace_, new Provider<Object>() {
    		public Object get() {
    			return ruleName("VariableDeclaration") + stringRepForEnv(G) + " |- " + stringRep(variable) + " : " + stringRep(ctx) + " : " + stringRep(_result_.getFirst());
    		}
    	});
    	addAsSubtrace(_trace_, _subtrace_);
    	return _result_;
    } catch (Exception e_applyRuleVariableDeclaration) {
    	objectTypeThrowException(ruleName("VariableDeclaration") + stringRepForEnv(G) + " |- " + stringRep(variable) + " : " + stringRep(ctx) + " : " + "IUMLTypeReference",
    		VARIABLEDECLARATION,
    		e_applyRuleVariableDeclaration, variable, ctx, new ErrorInformation[] {new ErrorInformation(variable), new ErrorInformation(ctx)});
    	return null;
    }
  }
  
  protected Result<IUMLTypeReference> applyRuleVariableDeclaration(final RuleEnvironment G, final RuleApplicationTrace _trace_, final Variable variable, final EObject ctx) throws RuleFailedException {
    IUMLTypeReference result = null; // output parameter
  ...
  protected Result<IUMLTypeReference> objectTypeImpl(final RuleEnvironment G, final RuleApplicationTrace _trace_, final CollectionVariable variable, final EObject ctx) throws RuleFailedException {
    try {
    	final RuleApplicationTrace _subtrace_ = newTrace(_trace_);
    	final Result<IUMLTypeReference> _result_ = applyRuleCollectionVariableDeclaration(G, _subtrace_, variable, ctx);
    	addToTrace(_trace_, new Provider<Object>() {
    		public Object get() {
    			return ruleName("CollectionVariableDeclaration") + stringRepForEnv(G) + " |- " + stringRep(variable) + " : " + stringRep(ctx) + " : " + stringRep(_result_.getFirst());
    		}
    	});
    	addAsSubtrace(_trace_, _subtrace_);
    	return _result_;
    } catch (Exception e_applyRuleCollectionVariableDeclaration) {
    	objectTypeThrowException(ruleName("CollectionVariableDeclaration") + stringRepForEnv(G) + " |- " + stringRep(variable) + " : " + stringRep(ctx) + " : " + "IUMLTypeReference",
    		COLLECTIONVARIABLEDECLARATION,
    		e_applyRuleCollectionVariableDeclaration, variable, ctx, new ErrorInformation[] {new ErrorInformation(variable), new ErrorInformation(ctx)});
    	return null;
    }
  }
  
  protected Result<IUMLTypeReference> applyRuleCollectionVariableDeclaration(final RuleEnvironment G, final RuleApplicationTrace _trace_, final CollectionVariable variable, final EObject ctx) throws RuleFailedException {
    IUMLTypeReference result = null; // output parameter
  ...
  protected Result<IUMLTypeReference> objectTypeImpl(final RuleEnvironment G, final RuleApplicationTrace _trace_, final LoopVariable variable, final EObject ctx) throws RuleFailedException {
    try {
    	final RuleApplicationTrace _subtrace_ = newTrace(_trace_);
    	final Result<IUMLTypeReference> _result_ = applyRuleLoopVariable(G, _subtrace_, variable, ctx);
    	addToTrace(_trace_, new Provider<Object>() {
    		public Object get() {
    			return ruleName("LoopVariable") + stringRepForEnv(G) + " |- " + stringRep(variable) + " : " + stringRep(ctx) + " : " + stringRep(_result_.getFirst());
    		}
    	});
    	addAsSubtrace(_trace_, _subtrace_);
    	return _result_;
    } catch (Exception e_applyRuleLoopVariable) {
    	objectTypeThrowException(ruleName("LoopVariable") + stringRepForEnv(G) + " |- " + stringRep(variable) + " : " + stringRep(ctx) + " : " + "IUMLTypeReference",
    		LOOPVARIABLE,
    		e_applyRuleLoopVariable, variable, ctx, new ErrorInformation[] {new ErrorInformation(variable), new ErrorInformation(ctx)});
    	return null;
    }
  }
  
  protected Result<IUMLTypeReference> applyRuleLoopVariable(final RuleEnvironment G, final RuleApplicationTrace _trace_, final LoopVariable variable, final EObject ctx) throws RuleFailedException {
    IUMLTypeReference result = null; // output parameter
    TypeDeclaration _type = variable.getType();
  ...
  protected Result<IUMLTypeReference> objectTypeImpl(final RuleEnvironment G, final RuleApplicationTrace _trace_, final FilterVariable variable, final EObject ctx) throws RuleFailedException {
    try {
    	final RuleApplicationTrace _subtrace_ = newTrace(_trace_);
    	final Result<IUMLTypeReference> _result_ = applyRuleFilterVariable(G, _subtrace_, variable, ctx);
    	addToTrace(_trace_, new Provider<Object>() {
    		public Object get() {
    			return ruleName("FilterVariable") + stringRepForEnv(G) + " |- " + stringRep(variable) + " : " + stringRep(ctx) + " : " + stringRep(_result_.getFirst());
    		}
    	});
    	addAsSubtrace(_trace_, _subtrace_);
    	return _result_;
    } catch (Exception e_applyRuleFilterVariable) {
    	objectTypeThrowException(ruleName("FilterVariable") + stringRepForEnv(G) + " |- " + stringRep(variable) + " : " + stringRep(ctx) + " : " + "IUMLTypeReference",
    		FILTERVARIABLE,
    		e_applyRuleFilterVariable, variable, ctx, new ErrorInformation[] {new ErrorInformation(variable), new ErrorInformation(ctx)});
    	return null;
    }
  }
  
  protected Result<IUMLTypeReference> applyRuleFilterVariable(final RuleEnvironment G, final RuleApplicationTrace _trace_, final FilterVariable variable, final EObject ctx) throws RuleFailedException {
    IUMLTypeReference result = null; // output parameter
    TypeDeclaration _type = variable.getType();
    boolean _notEquals = (!Objects.equal(_type, null));
    if (_notEquals) {
  ...
  protected Result<IUMLTypeReference> objectTypeImpl(final RuleEnvironment G, final RuleApplicationTrace _trace_, final Parameter parameter, final EObject ctx) throws RuleFailedException {
    try {
    	final RuleApplicationTrace _subtrace_ = newTrace(_trace_);
    	final Result<IUMLTypeReference> _result_ = applyRuleParameter(G, _subtrace_, parameter, ctx);
    	addToTrace(_trace_, new Provider<Object>() {
    		public Object get() {
    			return ruleName("Parameter") + stringRepForEnv(G) + " |- " + stringRep(parameter) + " : " + stringRep(ctx) + " : " + stringRep(_result_.getFirst());
    		}
    	});
    	addAsSubtrace(_trace_, _subtrace_);
    	return _result_;
    } catch (Exception e_applyRuleParameter) {
    	objectTypeThrowException(ruleName("Parameter") + stringRepForEnv(G) + " |- " + stringRep(parameter) + " : " + stringRep(ctx) + " : " + "IUMLTypeReference",
    		PARAMETER,
    		e_applyRuleParameter, parameter, ctx, new ErrorInformation[] {new ErrorInformation(parameter), new ErrorInformation(ctx)});
    	return null;
    }
  }
  
  protected Result<IUMLTypeReference> applyRuleParameter(final RuleEnvironment G, final RuleApplicationTrace _trace_, final Parameter parameter, final EObject ctx) throws RuleFailedException {
    IUMLTypeReference result = null; // output parameter
    IUMLTypeReference _typeOf = this.typeFactory.typeOf(parameter, ctx);
    result = _typeOf;
    return new Result<IUMLTypeReference>(result);
  }
  
  protected Result<IUMLTypeReference> objectTypeImpl(final RuleEnvironment G, final RuleApplicationTrace _trace_, final Type type, final EObject ctx) throws RuleFailedException {
    try {
    	final RuleApplicationTrace _subtrace_ = newTrace(_trace_);
    	final Result<IUMLTypeReference> _result_ = applyRuleType(G, _subtrace_, type, ctx);
    	addToTrace(_trace_, new Provider<Object>() {
    		public Object get() {
    			return ruleName("Type") + stringRepForEnv(G) + " |- " + stringRep(type) + " : " + stringRep(ctx) + " : " + stringRep(_result_.getFirst());
    		}
    	});
    	addAsSubtrace(_trace_, _subtrace_);
    	return _result_;
    } catch (Exception e_applyRuleType) {
    	objectTypeThrowException(ruleName("Type") + stringRepForEnv(G) + " |- " + stringRep(type) + " : " + stringRep(ctx) + " : " + "IUMLTypeReference",
    		TYPE,
    		e_applyRuleType, type, ctx, new ErrorInformation[] {new ErrorInformation(type), new ErrorInformation(ctx)});
    	return null;
    }
  }
  
  protected Result<IUMLTypeReference> applyRuleType(final RuleEnvironment G, final RuleApplicationTrace _trace_, final Type type, final EObject ctx) throws RuleFailedException {
    IUMLTypeReference result = null; // output parameter
  ...
  protected Result<IUMLTypeReference> objectTypeImpl(final RuleEnvironment G, final RuleApplicationTrace _trace_, final Property property, final EObject ctx) throws RuleFailedException {
    try {
    	final RuleApplicationTrace _subtrace_ = newTrace(_trace_);
    	final Result<IUMLTypeReference> _result_ = applyRuleProperty(G, _subtrace_, property, ctx);
    	addToTrace(_trace_, new Provider<Object>() {
    		public Object get() {
    			return ruleName("Property") + stringRepForEnv(G) + " |- " + stringRep(property) + " : " + stringRep(ctx) + " : " + stringRep(_result_.getFirst());
    		}
    	});
    	addAsSubtrace(_trace_, _subtrace_);
    	return _result_;
    } catch (Exception e_applyRuleProperty) {
    	objectTypeThrowException(ruleName("Property") + stringRepForEnv(G) + " |- " + stringRep(property) + " : " + stringRep(ctx) + " : " + "IUMLTypeReference",
    		PROPERTY,
    		e_applyRuleProperty, property, ctx, new ErrorInformation[] {new ErrorInformation(property), new ErrorInformation(ctx)});
    	return null;
    }
  }
  
  protected Result<IUMLTypeReference> applyRuleProperty(final RuleEnvironment G, final RuleApplicationTrace _trace_, final Property property, final EObject ctx) throws RuleFailedException {
    IUMLTypeReference result = null; // output parameter
    ...
    IUMLTypeReference _typeOf = this.typeFactory.typeOf(property, ctx);
    result = _typeOf;
    return new Result<IUMLTypeReference>(result);
  }
  
  protected Result<IUMLTypeReference> objectTypeImpl(final RuleEnvironment G, final RuleApplicationTrace _trace_, final EnumerationLiteral literal, final EObject ctx) throws RuleFailedException {
    try {
    	final RuleApplicationTrace _subtrace_ = newTrace(_trace_);
    	final Result<IUMLTypeReference> _result_ = applyRuleEnumerationLiteral(G, _subtrace_, literal, ctx);
    	addToTrace(_trace_, new Provider<Object>() {
    		public Object get() {
    			return ruleName("EnumerationLiteral") + stringRepForEnv(G) + " |- " + stringRep(literal) + " : " + stringRep(ctx) + " : " + stringRep(_result_.getFirst());
    		}
    	});
    	addAsSubtrace(_trace_, _subtrace_);
    	return _result_;
    } catch (Exception e_applyRuleEnumerationLiteral) {
    	objectTypeThrowException(ruleName("EnumerationLiteral") + stringRepForEnv(G) + " |- " + stringRep(literal) + " : " + stringRep(ctx) + " : " + "IUMLTypeReference",
    		ENUMERATIONLITERAL,
    		e_applyRuleEnumerationLiteral, literal, ctx, new ErrorInformation[] {new ErrorInformation(literal), new ErrorInformation(ctx)});
    	return null;
    }
  }
  
  protected Result<IUMLTypeReference> applyRuleEnumerationLiteral(final RuleEnvironment G, final RuleApplicationTrace _trace_, final EnumerationLiteral literal, final EObject ctx) throws RuleFailedException {
    IUMLTypeReference result = null; // output parameter
    Enumeration _enumeration = literal.getEnumeration();
    IUMLTypeReference _typeReference = this.typeFactory.typeReference(_enumeration);
    result = _typeReference;
    return new Result<IUMLTypeReference>(result);
  }
  ...
  protected Result<Boolean> applyRuleExpressionAssignableToType(final RuleEnvironment G, final RuleApplicationTrace _trace_, final Expression ex, final IUMLTypeReference target) throws RuleFailedException {
    ...
    IUMLContextProvider _umlContextProviderFor = this.contextAccess.getUmlContextProviderFor(ex);
    subtypeReferenceInternal(G, _trace_, expressionType, target, _umlContextProviderFor);
    return new Result<Boolean>(true);
  }
  ...
  protected Result<IUMLTypeReference> applyRuleOperationTypingWithResult(final RuleEnvironment G, final RuleApplicationTrace _trace_, final Operation op, final Tuple params, final EObject ctx) throws RuleFailedException {
    ...
    /* G |- op : ctx : result */
    Result<IUMLTypeReference> result_1 = objectTypeInternal(G, _trace_, op, ctx);
    checkAssignableTo(result_1.getFirst(), IUMLTypeReference.class);
  ...
  protected Result<IUMLTypeReference> objectTypeImpl(final RuleEnvironment G, final RuleApplicationTrace _trace_, final Expression ex, final EObject ctx) throws RuleFailedException {
    try {
    	final RuleApplicationTrace _subtrace_ = newTrace(_trace_);
    	final Result<IUMLTypeReference> _result_ = applyRuleExpressionObjectType(G, _subtrace_, ex, ctx);
    	addToTrace(_trace_, new Provider<Object>() {
    		public Object get() {
    			return ruleName("ExpressionObjectType") + stringRepForEnv(G) + " |- " + stringRep(ex) + " : " + stringRep(ctx) + " : " + stringRep(_result_.getFirst());
    		}
    	});
    	addAsSubtrace(_trace_, _subtrace_);
    	return _result_;
    } catch (Exception e_applyRuleExpressionObjectType) {
    	objectTypeThrowException(ruleName("ExpressionObjectType") + stringRepForEnv(G) + " |- " + stringRep(ex) + " : " + stringRep(ctx) + " : " + "IUMLTypeReference",
    		EXPRESSIONOBJECTTYPE,
    		e_applyRuleExpressionObjectType, ex, ctx, new ErrorInformation[] {new ErrorInformation(ex), new ErrorInformation(ctx)});
    	return null;
    }
  }
  
  protected Result<IUMLTypeReference> applyRuleExpressionObjectType(final RuleEnvironment G, final RuleApplicationTrace _trace_, final Expression ex, final EObject ctx) throws RuleFailedException {
    IUMLTypeReference result = null; // output parameter
    /* G |- ex : var IUMLTypeReference calc */
    IUMLTypeReference calc = null;
    Result<IUMLTypeReference> result_1 = typeInternal(G, _trace_, ex);
    checkAssignableTo(result_1.getFirst(), IUMLTypeReference.class);
    calc = (IUMLTypeReference) result_1.getFirst();
  ...
  protected Result<IUMLTypeReference> applyRuleNumericUnaryExpression(final RuleEnvironment G, final RuleApplicationTrace _trace_, final NumericUnaryExpression ex) throws RuleFailedException {
    IUMLTypeReference result = null; // output parameter
    final IUMLContextProvider umlContextProvider = this.contextAccess.getUmlContextProviderFor(ex);
    /* { ex.operand.type.value == INTEGER.primitiveTypeReference(umlContextProvider) result = INTEGER.primitiveTypeReference(umlContextProvider) } or { ex.operand.type.value == REAL.primitiveTypeReference(umlContextProvider) result = REAL.primitiveTypeReference(umlContextProvider) } */
    {
      RuleFailedException previousFailure = null;
      try {
        ...
        PrimitiveTypeReference _primitiveTypeReference_1 = this.typeFactory.primitiveTypeReference(this.INTEGER, umlContextProvider);
        ...
        PrimitiveTypeReference _primitiveTypeReference_2 = this.typeFactory.primitiveTypeReference(this.REAL, umlContextProvider);
        ...
        PrimitiveTypeReference _primitiveTypeReference_3 = this.typeFactory.primitiveTypeReference(this.REAL, umlContextProvider);
  ...
  protected Result<IUMLTypeReference> applyRuleArithmeticExpression(final RuleEnvironment G, final RuleApplicationTrace _trace_, final ArithmeticExpression ex) throws RuleFailedException {
    ...
    /* { ex.operator == "+" type1 == STRING.primitiveTypeReference(umlContextProvider) type2 == STRING.primitiveTypeReference(umlContextProvider) result = STRING.primitiveTypeReference(umlContextProvider) } or { ex.operator == "+" type1 == REAL.primitiveTypeReference(umlContextProvider) type2 == REAL.primitiveTypeReference(umlContextProvider) || type2 == INTEGER.primitiveTypeReference(umlContextProvider) result = REAL.primitiveTypeReference(umlContextProvider) } or { ex.operator == "+" type1 == REAL.primitiveTypeReference(umlContextProvider) || type1 == INTEGER.primitiveTypeReference(umlContextProvider) type2 == REAL.primitiveTypeReference(umlContextProvider) result = REAL.primitiveTypeReference(umlContextProvider) } or { ex.operator != "%" type1 == REAL.primitiveTypeReference(umlContextProvider) type2 == INTEGER.primitiveTypeReference(umlContextProvider) || type2 == REAL.primitiveTypeReference(umlContextProvider) result = REAL.primitiveTypeReference(umlContextProvider) } or { ex.operator != "%" type1 == INTEGER.primitiveTypeReference(umlContextProvider) || type1 == REAL.primitiveTypeReference(umlContextProvider) type2 == REAL.primitiveTypeReference(umlContextProvider) result = REAL.primitiveTypeReference(umlContextProvider) } or { type1 == INTEGER.primitiveTypeReference(umlContextProvider) type2 == INTEGER.primitiveTypeReference(umlContextProvider) result = INTEGER.primitiveTypeReference(umlContextProvider) } */
    {
      RuleFailedException previousFailure = null;
      try {
        ...
        PrimitiveTypeReference _primitiveTypeReference = this.typeFactory.primitiveTypeReference(this.STRING, umlContextProvider);
        ...
        PrimitiveTypeReference _primitiveTypeReference_2 = this.typeFactory.primitiveTypeReference(this.STRING, umlContextProvider);
        result = _primitiveTypeReference_2;
      } catch (Exception e) {
        previousFailure = extractRuleFailedException(e);
        /* { ex.operator == "+" type1 == REAL.primitiveTypeReference(umlContextProvider) type2 == REAL.primitiveTypeReference(umlContextProvider) || type2 == INTEGER.primitiveTypeReference(umlContextProvider) result = REAL.primitiveTypeReference(umlContextProvider) } or { ex.operator == "+" type1 == REAL.primitiveTypeReference(umlContextProvider) || type1 == INTEGER.primitiveTypeReference(umlContextProvider) type2 == REAL.primitiveTypeReference(umlContextProvider) result = REAL.primitiveTypeReference(umlContextProvider) } or { ex.operator != "%" type1 == REAL.primitiveTypeReference(umlContextProvider) type2 == INTEGER.primitiveTypeReference(umlContextProvider) || type2 == REAL.primitiveTypeReference(umlContextProvider) result = REAL.primitiveTypeReference(umlContextProvider) } or { ex.operator != "%" type1 == INTEGER.primitiveTypeReference(umlContextProvider) || type1 == REAL.primitiveTypeReference(umlContextProvider) type2 == REAL.primitiveTypeReference(umlContextProvider) result = REAL.primitiveTypeReference(umlContextProvider) } or { type1 == INTEGER.primitiveTypeReference(umlContextProvider) type2 == INTEGER.primitiveTypeReference(umlContextProvider) result = INTEGER.primitiveTypeReference(umlContextProvider) } */
        {
          try {
            ...
            boolean _or = false;
            PrimitiveTypeReference _primitiveTypeReference_4 = this.typeFactory.primitiveTypeReference(this.REAL, umlContextProvider);
            boolean _equals_5 = Objects.equal(type2, _primitiveTypeReference_4);
            if (_equals_5) {
              _or = true;
            } else {
              PrimitiveTypeReference _primitiveTypeReference_5 = this.typeFactory.primitiveTypeReference(this.INTEGER, umlContextProvider);
            ...
            PrimitiveTypeReference _primitiveTypeReference_6 = this.typeFactory.primitiveTypeReference(this.REAL, umlContextProvider);
            result = _primitiveTypeReference_6;
          } catch (Exception e_1) {
            previousFailure = extractRuleFailedException(e_1);
            /* { ex.operator == "+" type1 == REAL.primitiveTypeReference(umlContextProvider) || type1 == INTEGER.primitiveTypeReference(umlContextProvider) type2 == REAL.primitiveTypeReference(umlContextProvider) result = REAL.primitiveTypeReference(umlContextProvider) } or { ex.operator != "%" type1 == REAL.primitiveTypeReference(umlContextProvider) type2 == INTEGER.primitiveTypeReference(umlContextProvider) || type2 == REAL.primitiveTypeReference(umlContextProvider) result = REAL.primitiveTypeReference(umlContextProvider) } or { ex.operator != "%" type1 == INTEGER.primitiveTypeReference(umlContextProvider) || type1 == REAL.primitiveTypeReference(umlContextProvider) type2 == REAL.primitiveTypeReference(umlContextProvider) result = REAL.primitiveTypeReference(umlContextProvider) } or { type1 == INTEGER.primitiveTypeReference(umlContextProvider) type2 == INTEGER.primitiveTypeReference(umlContextProvider) result = INTEGER.primitiveTypeReference(umlContextProvider) } */
            {
              try {
                ...
                boolean _or_1 = false;
                PrimitiveTypeReference _primitiveTypeReference_7 = this.typeFactory.primitiveTypeReference(this.REAL, umlContextProvider);
                boolean _equals_8 = Objects.equal(type1, _primitiveTypeReference_7);
                if (_equals_8) {
                  _or_1 = true;
                } else {
                  PrimitiveTypeReference _primitiveTypeReference_8 = this.typeFactory.primitiveTypeReference(this.INTEGER, umlContextProvider);
                ...
                PrimitiveTypeReference _primitiveTypeReference_9 = this.typeFactory.primitiveTypeReference(this.REAL, umlContextProvider);
                ...
                PrimitiveTypeReference _primitiveTypeReference_10 = this.typeFactory.primitiveTypeReference(this.REAL, umlContextProvider);
                result = _primitiveTypeReference_10;
              } catch (Exception e_2) {
                previousFailure = extractRuleFailedException(e_2);
                /* { ex.operator != "%" type1 == REAL.primitiveTypeReference(umlContextProvider) type2 == INTEGER.primitiveTypeReference(umlContextProvider) || type2 == REAL.primitiveTypeReference(umlContextProvider) result = REAL.primitiveTypeReference(umlContextProvider) } or { ex.operator != "%" type1 == INTEGER.primitiveTypeReference(umlContextProvider) || type1 == REAL.primitiveTypeReference(umlContextProvider) type2 == REAL.primitiveTypeReference(umlContextProvider) result = REAL.primitiveTypeReference(umlContextProvider) } or { type1 == INTEGER.primitiveTypeReference(umlContextProvider) type2 == INTEGER.primitiveTypeReference(umlContextProvider) result = INTEGER.primitiveTypeReference(umlContextProvider) } */
                {
                  try {
                    ...
                    PrimitiveTypeReference _primitiveTypeReference_11 = this.typeFactory.primitiveTypeReference(this.REAL, umlContextProvider);
                    ...
                    boolean _or_2 = false;
                    PrimitiveTypeReference _primitiveTypeReference_12 = this.typeFactory.primitiveTypeReference(this.INTEGER, umlContextProvider);
                    boolean _equals_12 = Objects.equal(type2, _primitiveTypeReference_12);
                    if (_equals_12) {
                      _or_2 = true;
                    } else {
                      PrimitiveTypeReference _primitiveTypeReference_13 = this.typeFactory.primitiveTypeReference(this.REAL, umlContextProvider);
                    ...
                    PrimitiveTypeReference _primitiveTypeReference_14 = this.typeFactory.primitiveTypeReference(this.REAL, umlContextProvider);
                    ...
                    /* { ex.operator != "%" type1 == INTEGER.primitiveTypeReference(umlContextProvider) || type1 == REAL.primitiveTypeReference(umlContextProvider) type2 == REAL.primitiveTypeReference(umlContextProvider) result = REAL.primitiveTypeReference(umlContextProvider) } or { type1 == INTEGER.primitiveTypeReference(umlContextProvider) type2 == INTEGER.primitiveTypeReference(umlContextProvider) result = INTEGER.primitiveTypeReference(umlContextProvider) } */
                    {
                      try {
                        ...
                        boolean _or_3 = false;
                        PrimitiveTypeReference _primitiveTypeReference_15 = this.typeFactory.primitiveTypeReference(this.INTEGER, umlContextProvider);
                        boolean _equals_14 = Objects.equal(type1, _primitiveTypeReference_15);
                        if (_equals_14) {
                          _or_3 = true;
                        } else {
                          PrimitiveTypeReference _primitiveTypeReference_16 = this.typeFactory.primitiveTypeReference(this.REAL, umlContextProvider);
                        ...
                        PrimitiveTypeReference _primitiveTypeReference_17 = this.typeFactory.primitiveTypeReference(this.REAL, umlContextProvider);
                        boolean _equals_16 = Objects.equal(type2, _primitiveTypeReference_17);
                        /* type2 == REAL.primitiveTypeReference(umlContextProvider) */
                        if (!_equals_16) {
                          sneakyThrowRuleFailedException("type2 == REAL.primitiveTypeReference(umlContextProvider)");
                        }
                        PrimitiveTypeReference _primitiveTypeReference_18 = this.typeFactory.primitiveTypeReference(this.REAL, umlContextProvider);
                        result = _primitiveTypeReference_18;
                      } catch (Exception e_4) {
                        previousFailure = extractRuleFailedException(e_4);
                        PrimitiveTypeReference _primitiveTypeReference_19 = this.typeFactory.primitiveTypeReference(this.INTEGER, umlContextProvider);
                        ...
                        PrimitiveTypeReference _primitiveTypeReference_20 = this.typeFactory.primitiveTypeReference(this.INTEGER, umlContextProvider);
                        ...
                        PrimitiveTypeReference _primitiveTypeReference_21 = this.typeFactory.primitiveTypeReference(this.INTEGER, umlContextProvider);
  ...
  protected Result<IUMLTypeReference> applyRuleNameExpression(final RuleEnvironment G, final RuleApplicationTrace _trace_, final NameExpression ex) throws RuleFailedException {
    ...
    IUMLTypeReference varType = null;
    Result<IUMLTypeReference> result_1 = objectTypeInternal(G, _trace_, _reference, ex);
    checkAssignableTo(result_1.getFirst(), IUMLTypeReference.class);
  ...
  protected Result<IUMLTypeReference> applyRuleFilterExpression(final RuleEnvironment G, final RuleApplicationTrace _trace_, final FilterExpression ex) throws RuleFailedException {
    ...
    Result<IUMLTypeReference> result_1 = objectTypeInternal(G, _trace_, _declaration, ex);
    checkAssignableTo(result_1.getFirst(), IUMLTypeReference.class);
    ...
    IUMLTypeReference _valueType = contextType.getValueType();
    IUMLContextProvider _umlContextProviderFor = this.contextAccess.getUmlContextProviderFor(ex);
    subtypeReferenceInternal(G, _trace_, _valueType, declarationType, _umlContextProviderFor);
    IUMLContextProvider _umlContextProviderFor_1 = this.contextAccess.getUmlContextProviderFor(ex);
    PrimitiveTypeReference _primitiveTypeReference = this.typeFactory.primitiveTypeReference(this.BOOLEAN, _umlContextProviderFor_1);
  ...
  protected Result<IUMLTypeReference> applyRuleAssignmentExpression(final RuleEnvironment G, final RuleApplicationTrace _trace_, final AssignmentExpression ex) throws RuleFailedException {
    ...
    IUMLContextProvider _umlContextProviderFor = this.contextAccess.getUmlContextProviderFor(ex);
    subtypeReferenceInternal(G, _trace_, leftType, rightType, _umlContextProviderFor);
    result = rightType;
    return new Result<IUMLTypeReference>(result);
  }
  ...
  protected Result<IUMLTypeReference> applyRulePrefixExpression(final RuleEnvironment G, final RuleApplicationTrace _trace_, final PrefixExpression ex) throws RuleFailedException {
    ...
    Result<IUMLTypeReference> result_1 = objectTypeInternal(G, _trace_, _operand, ex);
    checkAssignableTo(result_1.getFirst(), IUMLTypeReference.class);
  ...
  protected Result<IUMLTypeReference> applyRuleShiftExpression(final RuleEnvironment G, final RuleApplicationTrace _trace_, final ShiftExpression ex) throws RuleFailedException {
    ...
    PrimitiveTypeReference _primitiveTypeReference_2 = this.typeFactory.primitiveTypeReference(this.INTEGER, umlContextProvider);
    result = _primitiveTypeReference_2;
    return new Result<IUMLTypeReference>(result);
  }
  ...
  protected Result<IUMLTypeReference> applyRuleEqualityExpression(final RuleEnvironment G, final RuleApplicationTrace _trace_, final EqualityExpression ex) throws RuleFailedException {
    ...
    final IUMLContextProvider umlContextProvider = this.contextAccess.getUmlContextProviderFor(ex);
    /* G |- op1Type <: op2Type : umlContextProvider or G |- op2Type <: op1Type : umlContextProvider */
    {
      RuleFailedException previousFailure = null;
      try {
        /* G |- op1Type <: op2Type : umlContextProvider */
        subtypeReferenceInternal(G, _trace_, op1Type, op2Type, umlContextProvider);
      } catch (Exception e) {
        previousFailure = extractRuleFailedException(e);
        /* G |- op2Type <: op1Type : umlContextProvider */
        subtypeReferenceInternal(G, _trace_, op2Type, op1Type, umlContextProvider);
      }
    }
    PrimitiveTypeReference _primitiveTypeReference = this.typeFactory.primitiveTypeReference(this.BOOLEAN, umlContextProvider);
  ...
  protected Result<IUMLTypeReference> applyRuleRelationalExpression(final RuleEnvironment G, final RuleApplicationTrace _trace_, final RelationalExpression ex) throws RuleFailedException {
    ...
    if (_equals) {
      ...
      PrimitiveTypeReference _primitiveTypeReference_1 = this.typeFactory.primitiveTypeReference(this.REAL, umlContextProvider);
    ...
    PrimitiveTypeReference _primitiveTypeReference_4 = this.typeFactory.primitiveTypeReference(this.BOOLEAN, umlContextProvider);
  ...
  protected Result<IUMLTypeReference> applyRuleLogicalUnaryExpression(final RuleEnvironment G, final RuleApplicationTrace _trace_, final BooleanUnaryExpression ex) throws RuleFailedException {
    ...
    PrimitiveTypeReference _primitiveTypeReference_1 = this.typeFactory.primitiveTypeReference(this.BOOLEAN, umlContextProvider);
    result = _primitiveTypeReference_1;
    return new Result<IUMLTypeReference>(result);
  }
  ...
  protected Result<IUMLTypeReference> applyRuleLogicalExpression(final RuleEnvironment G, final RuleApplicationTrace _trace_, final LogicalExpression ex) throws RuleFailedException {
    ...
    final IUMLContextProvider umlContextProvider = this.contextAccess.getUmlContextProviderFor(ex);
    /* { op1Type == BOOLEAN.primitiveTypeReference(umlContextProvider) op2Type == BOOLEAN.primitiveTypeReference(umlContextProvider) result = BOOLEAN.primitiveTypeReference(umlContextProvider) } or { op1Type == INTEGER.primitiveTypeReference(umlContextProvider) op2Type == INTEGER.primitiveTypeReference(umlContextProvider) result = INTEGER.primitiveTypeReference(umlContextProvider) } */
    {
      RuleFailedException previousFailure = null;
      try {
        PrimitiveTypeReference _primitiveTypeReference = this.typeFactory.primitiveTypeReference(this.BOOLEAN, umlContextProvider);
        ...
        PrimitiveTypeReference _primitiveTypeReference_2 = this.typeFactory.primitiveTypeReference(this.BOOLEAN, umlContextProvider);
        result = _primitiveTypeReference_2;
      } catch (Exception e) {
        previousFailure = extractRuleFailedException(e);
        PrimitiveTypeReference _primitiveTypeReference_3 = this.typeFactory.primitiveTypeReference(this.INTEGER, umlContextProvider);
        boolean _equals_2 = Objects.equal(op1Type, _primitiveTypeReference_3);
        /* op1Type == INTEGER.primitiveTypeReference(umlContextProvider) */
        if (!_equals_2) {
          sneakyThrowRuleFailedException("op1Type == INTEGER.primitiveTypeReference(umlContextProvider)");
        }
        PrimitiveTypeReference _primitiveTypeReference_4 = this.typeFactory.primitiveTypeReference(this.INTEGER, umlContextProvider);
  ...
  protected Result<IUMLTypeReference> applyRuleConditionalTestExpression(final RuleEnvironment G, final RuleApplicationTrace _trace_, final ConditionalTestExpression ex) throws RuleFailedException {
    ...
    subtypeReferenceInternal(G, _trace_, trueType, falseType, umlContextProvider);
    PrimitiveTypeReference _primitiveTypeReference = this.typeFactory.primitiveTypeReference(this.BOOLEAN, umlContextProvider);
  ...
  protected Result<IUMLTypeReference> applyRuleThisExpression(final RuleEnvironment G, final RuleApplicationTrace _trace_, final ThisExpression ex) throws RuleFailedException {
    IUMLTypeReference result = null; // output parameter
    final IUMLContextProvider umlContextProvider = this.contextAccess.getUmlContextProviderFor(ex);
    org.eclipse.uml2.uml.Class _thisType = umlContextProvider.getThisType(ex);
    boolean _equals = Objects.equal(_thisType, null);
    if (_equals) {
      IUMLTypeReference.AnyTypeReference _anyType = this.typeFactory.anyType();
      result = _anyType;
    } else {
      org.eclipse.uml2.uml.Class _thisType_1 = umlContextProvider.getThisType(ex);
  ...
  protected Result<IUMLTypeReference> applyRuleSignalDataExpression(final RuleEnvironment G, final RuleApplicationTrace _trace_, final SignalDataExpression ex) throws RuleFailedException {
    IUMLTypeReference result = null; // output parameter
    IUMLContextProvider _umlContextProviderFor = this.contextAccess.getUmlContextProviderFor(ex);
    final Signal signalType = _umlContextProviderFor.getIncomingSignalType(ex);
    boolean _or = false;
  ...
  protected Result<IUMLTypeReference> applyRuleAssociationAccessExpression(final RuleEnvironment G, final RuleApplicationTrace _trace_, final AssociationAccessExpression ex) throws RuleFailedException {
    ...
    IUMLTypeReference _collectionTypeOf = this.typeFactory.collectionTypeOf(_association_2, contextType, ex);
  ...
  protected Result<IUMLTypeReference> applyRuleCollectionConstructionExpression(final RuleEnvironment G, final RuleApplicationTrace _trace_, final ElementCollectionExpression ex) throws RuleFailedException {
    ...
    for (final Expression element : _expressions_1) {
      ...
      IUMLContextProvider _umlContextProviderFor = this.contextAccess.getUmlContextProviderFor(ex);
      subtypeReferenceInternal(G, _trace_, valueType, elType, _umlContextProviderFor);
    }
    ...
    if (_notEquals_1) {
      ...
      IUMLContextProvider _umlContextProviderFor_1 = this.contextAccess.getUmlContextProviderFor(ex);
      CollectionType _collectionType_2 = ex.getCollectionType();
      Classifier _collectionType_3 = _umlContextProviderFor_1.getCollectionType(_collectionType_2);
      CollectionTypeReference _collectionOf = this.typeFactory.collectionOf(valueType, _collectionType_1, _collectionType_3);
      result = _collectionOf;
    } else {
      CollectionTypeReference _sequenceOf = this.typeFactory.sequenceOf(valueType, ex);
      result = _sequenceOf;
    }
    return new Result<IUMLTypeReference>(result);
  }
  ...
  protected Result<IUMLTypeReference> applyRuleFeatureInvocationExpression(final RuleEnvironment G, final RuleApplicationTrace _trace_, final FeatureInvocationExpression ex) throws RuleFailedException {
    IUMLTypeReference result = null; // output parameter
    /* { ex.^feature instanceof Operation G |- ex.^feature : ex : var IUMLTypeReference opType result = replaceGenericTypeReference(G, opType, ex.context) } or { ex.^feature instanceof Property val property = ex.^feature as Property G |- property : ex : result } or { fail error previousFailure.message feature featureInvocationExpression_Feature } */
    {
      RuleFailedException previousFailure = null;
      try {
        Feature _feature = ex.getFeature();
        ...
        Feature _feature_1 = ex.getFeature();
        IUMLTypeReference opType = null;
        Result<IUMLTypeReference> result_1 = objectTypeInternal(G, _trace_, _feature_1, ex);
        checkAssignableTo(result_1.getFirst(), IUMLTypeReference.class);
        opType = (IUMLTypeReference) result_1.getFirst();
        ...
        previousFailure = extractRuleFailedException(e);
        /* { ex.^feature instanceof Property val property = ex.^feature as Property G |- property : ex : result } or { fail error previousFailure.message feature featureInvocationExpression_Feature } */
        {
          try {
            ...
            Result<IUMLTypeReference> result_2 = objectTypeInternal(G, _trace_, property, ex);
            checkAssignableTo(result_2.getFirst(), IUMLTypeReference.class);
  ...
  protected Result<IUMLTypeReference> objectTypeImpl(final RuleEnvironment G, final RuleApplicationTrace _trace_, final Operation op, final EObject ctx) throws RuleFailedException {
    try {
    	final RuleApplicationTrace _subtrace_ = newTrace(_trace_);
    	final Result<IUMLTypeReference> _result_ = applyRuleOperation(G, _subtrace_, op, ctx);
    	addToTrace(_trace_, new Provider<Object>() {
    		public Object get() {
    			return ruleName("Operation") + stringRepForEnv(G) + " |- " + stringRep(op) + " : " + stringRep(ctx) + " : " + stringRep(_result_.getFirst());
    		}
    	});
    	addAsSubtrace(_trace_, _subtrace_);
    	return _result_;
    } catch (Exception e_applyRuleOperation) {
    	objectTypeThrowException(ruleName("Operation") + stringRepForEnv(G) + " |- " + stringRep(op) + " : " + stringRep(ctx) + " : " + "IUMLTypeReference",
    		OPERATION,
    		e_applyRuleOperation, op, ctx, new ErrorInformation[] {new ErrorInformation(op), new ErrorInformation(ctx)});
    	return null;
    }
  }
  
  protected Result<IUMLTypeReference> applyRuleOperation(final RuleEnvironment G, final RuleApplicationTrace _trace_, final Operation op, final EObject ctx) throws RuleFailedException {
    IUMLTypeReference result = null; // output parameter
    /* { op.getType == null result = voidType } or { result = op.returnParameter.typeOf(ctx) } */
    {
      RuleFailedException previousFailure = null;
      try {
        ...
        IUMLTypeReference _typeOf = this.typeFactory.typeOf(_returnParameter, ctx);
        result = _typeOf;
      }
    }
    return new Result<IUMLTypeReference>(result);
  ...
  protected Result<IUMLTypeReference> applyRuleClassExtentExpression(final RuleEnvironment G, final RuleApplicationTrace _trace_, final ClassExtentExpression ex) throws RuleFailedException {
    ...
    CollectionTypeReference _setOf = this.typeFactory.setOf(classType, ex);
    result = _setOf;
    return new Result<IUMLTypeReference>(result);
  }
  ...
  protected Result<IUMLTypeReference> applyRuleCastExpression(final RuleEnvironment G, final RuleApplicationTrace _trace_, final CastExpression ex) throws RuleFailedException {
    ...
    Result<IUMLTypeReference> result_1 = objectTypeInternal(G, _trace_, _type, ex);
    checkAssignableTo(result_1.getFirst(), IUMLTypeReference.class);
  ...
  protected Result<IUMLTypeReference> objectTypeImpl(final RuleEnvironment G, final RuleApplicationTrace _trace_, final LeftHandSide lhs, final EObject ctx) throws RuleFailedException {
    try {
    	final RuleApplicationTrace _subtrace_ = newTrace(_trace_);
    	final Result<IUMLTypeReference> _result_ = applyRuleFeatureLeftHandSide(G, _subtrace_, lhs, ctx);
    	addToTrace(_trace_, new Provider<Object>() {
    		public Object get() {
    			return ruleName("FeatureLeftHandSide") + stringRepForEnv(G) + " |- " + stringRep(lhs) + " : " + stringRep(ctx) + " : " + stringRep(_result_.getFirst());
    		}
    	});
    	addAsSubtrace(_trace_, _subtrace_);
    	return _result_;
    } catch (Exception e_applyRuleFeatureLeftHandSide) {
    	objectTypeThrowException(ruleName("FeatureLeftHandSide") + stringRepForEnv(G) + " |- " + stringRep(lhs) + " : " + stringRep(ctx) + " : " + "IUMLTypeReference",
    		FEATURELEFTHANDSIDE,
    		e_applyRuleFeatureLeftHandSide, lhs, ctx, new ErrorInformation[] {new ErrorInformation(lhs), new ErrorInformation(ctx)});
    	return null;
    }
  }
  
  protected Result<IUMLTypeReference> applyRuleFeatureLeftHandSide(final RuleEnvironment G, final RuleApplicationTrace _trace_, final LeftHandSide lhs, final EObject ctx) throws RuleFailedException {
    IUMLTypeReference result = null; // output parameter
